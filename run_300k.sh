...
COMBINED_TOK_OUT="${COMBINED_TOK_OUT:-data/combined_300k_tok.csv}"
...
RUN_NAME="${RUN_NAME:-unit_300k}"
EPOCHS="${EPOCHS:-45}"
BATCH_SIZE="${BATCH_SIZE:-48}" # Adjust based on GPU memory; 48 works on my 5070 with AMP and dynamic padding.
